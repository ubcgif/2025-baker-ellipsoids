...
import numpy as np
from .get_gravity_ellipsoids import _get_gz_array
from .utils import _get_ellipsoid_mass, _get_coords_and_mask
import verde as vd
...
def plot_colourmap_gz(
    region, spacing, extra_coords, a, b, c, density, func, topo_h=None
):
    """
    ...
    xresults, yresults, zresults = get_gz_array(
        region, spacing, extra_coords, a, b, c, density, func, topo_h
    )
